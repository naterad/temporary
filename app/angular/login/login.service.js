...
var LoginService = (function () {
    function LoginService(http) {
        this.http = http;
        this.loginUrl = localStorage.getItem('API_URL') + '/login/';
        this.loginFacebookUrl = localStorage.getItem('API_URL') + '/login/facebook';
        this.loginGoogleUrl = localStorage.getItem('API_URL') + '/login/google';
        this.registerUserUrl = localStorage.getItem('API_URL') + '/user/';
        this.userDetailsUrl = localStorage.getItem('API_URL') + '/user/';
    }
    ...
    LoginService.prototype.loginFacebook = function (code) {
        console.log(code);
    ...
    LoginService.prototype.loginGoogle = function (code) {
        console.log(code);
        var body = JSON.stringify(code);
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' });
        var options = new http_2.RequestOptions({ headers: headers });
    ...
    LoginService.prototype.getUserDetails = function (token) {
