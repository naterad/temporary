...
//might have to build a function
export class Addendum {
  constructor(
    // public addendum_utah_id: string,
    // public offer_id: string,
    // public pdf_url: string,
    // public comment: string,
    // public counter_addendum_utah_id: string,
    // public counter_offer_id: string,
    // public some_utah_field: string,
  ){}
}
