...
$(document).ready(function ($) {
    ...
    //header - footer
    // $.get("app/angular/common/header.component.html", function (data) {
    //     $('#header').append(data);
    //     $('.selection').selectize({ sortField: 'text' });
    //     $(".selectize-input input").attr('readonly', 'readonly');
    // });

    // $.get("app/angular/common/footer.component.html", function (data) {
    //     $('#footer').append(data);
    // });

    // modal blocks
    $.get("app/angular/login/modal_log_in.html", function (data) {
        $('#login-modal-open').append(data);
    });
    $.get("app/angular/login/modal_register.html", function (data) {
